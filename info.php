          ...
          <div style=" width: 100%">
            <div class="slideshow col-lg-6" >
               <div class="infoslideshow">
                ...
                <img id="f" onload="fifo()" src="<?php echo $imgsrc; ?>"  style="padding-top: 90px;">
                <script>
                  ...
                  function fifo() {
                         if(b==1){        //width:65%;height:83%;
                              ...
                              document.getElementById('f').style.width = 'auto';
                              //document.getElementById('f').style.width = 400+'px';
                             
                            }
                         else if (b==2)   //width:83%;height:60%;
                            {
                           document.getElementById('f').style.height = 350+'px';
                           document.getElementById('f').style.width = 'auto';
                           //   document.getElementById('f').style.width = 400+'px';
...
//                           document.getElementById('f').style.height = 450+'px';
                              ...
                              document.getElementById('f').style.width = 300+'px';
                          }
                          else if (b==4)  //width:68%;height:92%;
                            {
                              document.getElementById('f').style.width = 'auto';
                              document.getElementById('f').style.height = 460+'px';
                              //document.getElementById('f').style.width = 350+'px';
                          }
              ...
              <?php  
                 ...
                 // echo "$cat_id";
                  ...
                  $pid = (int)(($cat_id-1)*10)+(int)$row_id;

                 /* if ($row_id == "10")
                  {
                    $pid = (int) $row_id * (int)$cat_id;
                  } 
                  else
                  {
                    $pid = $cat_id-1 . $row_id;
